...
namespace Kuchulem.DotNet.Extensions.Tests.Strings
{
    class StringExtensions_ToSlug_Should
    {
        ...
        public void ProvideDefaultSlug()
        {
            ...
            Assert.AreEqual(expected, input.ToSlug());
        }
        ...
        public void ProvideSlugRemovingMultipleSpacings()
        {
            ...
            Assert.AreEqual(expected, input.ToSlug(StringExtensions.StringToSlugOptions.ReduceSpacingChars));
        }
        ...
        public void ProvideSlugWithUnderscores()
        {
            ...
            Assert.AreEqual(expected, input.ToSlug(StringExtensions.StringToSlugOptions.ReduceSpacingChars, '_'));
        }
        ...
        public void ProvideUppercaseSlugWithUnderscores()
        {
            ...
            Assert.AreEqual(expected, input.ToSlug(StringExtensions.StringToSlugOptions.ReduceSpacingChars | StringExtensions.StringToSlugOptions.Capitalize, '_'));
        }
    }
}
